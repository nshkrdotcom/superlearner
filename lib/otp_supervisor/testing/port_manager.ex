defmodule OTPSupervisor.Testing.PortManager do
  ...
  defp generate_alternative_port_bases(config) do
    ...
    # Add some buffer between ranges
    step_size = range_size + 50
  ...
  defp get_known_service_ports(_config) do
    ...
    base_ports = [
      # Phoenix dev server default
      4000,
      # Phoenix dev server alternative
      4001,
      # Phoenix test server (from config)
      4002,
      # Common web dev port
      3000,
      # Common web dev port
      ...
      # Redis default
      6379,
      # Common Elixir distribution port base
      9100
    ]
