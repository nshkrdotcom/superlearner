...
config :otp_supervisor, OtpSupervisorWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "UCQKFRm1SfCqjVY+joBKEFsoDsZbKZRJtwbBCxKdW3yQWQzAER/cnS3+LqHbGcgQ",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:otp_supervisor, ~w(--sourcemap=inline --watch)]},
